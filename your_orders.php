            ...
            <section class="restaurants-page">
                <div class="container">
                    <div class="row">
						...
						$query= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
												<tr>	
												        <td data-column="Restaurants"> <?php echo $row['title']; ?></td>
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="price">₹<?php echo $row['price']; ?></td>
														   ...
														   <?php 
																			...
																			{
																			?>
																			<button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span> On Process!</button>
																		   <?php 
																			  }
																			   if($status=="in process")
																			 { ?>
																				<button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Ready</button>
																			<?php
																				}
																			if($status=="closed")
																				{
